...
## Developer Workflow
Add a root script that starts headless + web with auto-connect:
- Proposed script: `dev:headless-web`
- Example usage:
  - `OPENWORK_TOKEN=... OPENWORK_HOST_TOKEN=... VITE_OPENWORK_URL=http://127.0.0.1:8787 pnpm dev:headless-web`
